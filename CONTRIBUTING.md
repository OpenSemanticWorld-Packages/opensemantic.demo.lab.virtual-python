...
Welcome to `opensemantic.demo.lab.virtual` contributor's guide.
...
If you experience bugs or general issues with `opensemantic.demo.lab.virtual`, please have a look
...
You can help improve `opensemantic.demo.lab.virtual` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`opensemantic.demo.lab.virtual` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `opensemantic.demo.lab.virtual`'s files. While this mechanism can
...
```
conda create -n opensemantic.demo.lab.virtual python=3 six virtualenv pytest pytest-cov
conda activate opensemantic.demo.lab.virtual
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/opensemantic.demo.lab.virtual.git
   cd opensemantic.demo.lab.virtual
   ```
...
5. Install [pre-commit]:
   ...
   `opensemantic.demo.lab.virtual` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/opensemantic.demo.lab.virtual
[issue tracker]: https://github.com/<USERNAME>/opensemantic.demo.lab.virtual/issues
